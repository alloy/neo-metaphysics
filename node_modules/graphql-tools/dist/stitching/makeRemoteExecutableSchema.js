...
var addSimpleRoutingResolvers_1 = require("./addSimpleRoutingResolvers");
function makeRemoteExecutableSchema(fetcher) {
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (introspectionResult.errors || !introspectionResult.data.__schema) {
                        ...
                        // console.log(require('util').inspect(introspectionResult.data, false, null))
                        schema = graphql_1.buildClientSchema(introspectionResult.data);
                        return [2 /*return*/, addSimpleRoutingResolvers_1.default(schema, fetcher)];
                    }
                    return [2 /*return*/];
            }
        });
